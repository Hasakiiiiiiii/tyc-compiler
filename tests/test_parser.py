...
200+ comprehensive test cases covering all grammar rules
"""
...
# ========== Simple Test Cases (from upstream) ==========

def test_empty_program():
    """1. Empty program with main"""
